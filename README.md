...
const habiburRahman = {
  ...
  describe() {
    console.log(`Hi, I'm ${this.name}, a passionate ${
      this.profession
    } with expertise in ${this.skills.join(', ')}.
I specialize in ${this.expertise.join(
      ', '
    )} and thrive on transforming ideas into beautiful and interactive web experiences.
My passion lies in ${
      this.passion
    }, ensuring that users have a seamless and engaging browsing experience.
